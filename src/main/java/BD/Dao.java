...
public class Dao {
    ...
    private void crearTablas(){
        String queryArticulo = "CREATE TABLE IF NOT EXISTS Articulo(articulo_id BIGINT PRIMARY KEY NOT NULL auto_increment, titulo VARCHAR(200),"+
        ...
        String queryComentario = "CREATE TABLE IF NOT EXISTS Comentario(comentario_id BIGINT PRIMARY KEY NOT NULL auto_increment, comentario VARCHAR, autor VARCHAR(100), " +
                                "articulo_id BIGINT," +
                                "FOREIGN KEY (autor_id) REFERENCES Usuario(username), FOREIGN KEY (articulo) REFERENCES Articulo(articulo_id));";

        String queryEtiqueta = "CREATE TABLE IF NOT EXISTS Etiqueta(etiqueta_id BIGINT PRIMARY KEY NOT NULL auto_increment, etiqueta VARCHAR(80));";
